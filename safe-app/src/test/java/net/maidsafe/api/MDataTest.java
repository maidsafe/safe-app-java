...
//        // Delete
//        actionHandle = client.mDataEntryAction.newEntryAction().get();
//        client.mDataEntryAction.delete(actionHandle, entry.getKey().getVal(), entry.getValue().getEntryVersion() + 1).get();
//        client.mData.mutateEntries(mDataInfo, actionHandle).get();
//
//        entriesHandle = client.mData.getEntriesHandle(mDataInfo).get();
//        entries = client.mDataEntries.listEntries(entriesHandle).get();
...
//        Assert.assertEquals(new String(entries.get(0).getKey().getVal()), new String(keys.get(0).getVal()));
//        Assert.assertEquals(new String(entries.get(0).getValue().getContent()), new String(values.get(0).getContent()));
//
...
//        client.mDataPermission.insert(permissionHandle, client.crypto.getAppPublicSignKey().get(), permissionSet).get();
//        client.mData.setUserPermission(client.crypto.getAppPublicSignKey().get(), mDataInfo, permissionSet, client.mData.getVersion(mDataInfo).get() + 1).get();
...
//        client.mDataEntryAction.update(actionHandle, entry.getKey().getVal(), encryptedUpdatedValue, entry.getValue().getEntryVersion() + 1).get();
//        client.mData.mutateEntries(mDataInfo, actionHandle).get();
//
