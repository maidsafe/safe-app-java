...
public class TestHelper {
  ...
  public static Future<Object> createSession() throws Exception {
    return createSession(APP_ID);
  }

  public static Future<Object> createSession(String appId) throws Exception {
  ...
  public static Future<Object> createSession(AuthReq authReq) throws Exception {
    String locator = TestHelper.randomAlphaNumeric(10);
    String secret = TestHelper.randomAlphaNumeric(10);
    return createSession(locator, secret, authReq);
  }

  public static Future<Object> createSession(String locator, String secret, AuthReq authReq)
      throws Exception {
    ...
    System.out.println("Decoded requeat");
