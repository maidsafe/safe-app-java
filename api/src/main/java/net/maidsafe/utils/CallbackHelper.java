...
public class CallbackHelper<T> implements Callable<T> {
    ...
    public T call() throws Exception {
        ResultBinder<T> binder = new ResultBinder<>();
    ...
    private class ResultBinder<T> implements Binder<T> {
        T result;
        Exception exception;
        ...
        public synchronized void execute() {
            funcExecutor.exec((Binder) this);
        }
    }

    private class Handler<T> implements Runnable {
